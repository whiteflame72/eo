      ...
      <div class="wrapper">
                          ...
                          <div class="corner-bot-right">
                            <div class="box-indent">
                              <ul class="list">
                                ...
                                <li><a href="http://eoldev2.eoldevsite.com:9090/ProgramGoals/ProgramGoals/jsp/parent_input_form_tmp.jsp">Parent Input</a></li>
        ...
        <div class="col-2">
          ...
          <br />
            ...
            <li class="act">
			<form action="http://127.0.0.1:8080/myReporting/index.jsp" method="get">
			
			<input type="hidden" name="goalsrespondentidname" id="goalsrespondentid" value="${respondentId}" />
			 
			<input type="submit"	id="reportsbutton"  value="Reports" />	
